...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    replace: {
      baseurl: {
        ...
        replacements: [{
          from: '/styles/',
          to: '<%= config.baseurl %>/styles/'
        }, {
          from: '/scripts/',
          to: '<%= config.baseurl %>/scripts/'
        }, {
          from: '/images/',
          to: '<%= config.baseurl %>/images/'
        }, {
          from: '/favicon',
          to: '<%= config.baseurl %>/favicon'
        }, {
          from: 'apple-touch-icon.png',
          to: '<%= config.baseurl %>/apple-touch-icon.png'
        }, {
          from: 'data/',
          to: '<%= config.baseurl %>/data/'
        }]
      }
    },
  });
  ...
  grunt.task.registerTask('post', 'Create new jekyll posts from templates.', function() {
    ...
    if (title) {
      ...
      grunt.file.write('app/_posts/' + today + '-' + formattedTitle + '.md', content);
    }
    else {
      grunt.fail.warn('Title Required: `grunt post --title "My Post Title"`');
    }
  });
